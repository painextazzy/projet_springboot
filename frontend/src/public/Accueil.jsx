...
export default function Accueil() {
  ...
  return (
    <div className="font-body text-on-surface antialiased">
      <main className="relative min-h-screen w-full flex items-center justify-center p-4 bg-[#f3f4f6]">
        {/* Login Card - Version compacte */}
        <div className="relative z-10 w-full max-w-3xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
