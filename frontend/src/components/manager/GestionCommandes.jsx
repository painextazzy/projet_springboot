...
export default function GestionCommandes() {
  ...
  // Compter les commandes EN_COURS pour la bulle
  ...
  useEffect(() => {
    chargerCommandes();
    const interval = setInterval(chargerCommandes, 20000);
  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto px-6 py-12">
        ...
        <section className="mb-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center p-1 bg-surface-container-highest/60 rounded-lg w-fit">
            ...
            >
              En cours
              {/* Bulle de notification sur le filtre "En cours" */}
        ...
        <div className="bg-white rounded-2xl shadow-[0px_4px_24px_rgba(0,0,0,0.04)] overflow-hidden border border-outline-variant/15">
          ...
          <footer className="px-6 py-6 bg-white border-t border-outline-variant/10 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button className="w-9 h-9 flex items-center justify-center rounded-md border border-outline-variant/10 bg-white text-secondary/60 hover:bg-surface-container-low transition-all">
                <span className="material-symbols-outlined text-lg">
                  chevron_left
                </span>
              </button>
              <button className="w-9 h-9 flex items-center justify-center rounded-md bg-primary text-white text-xs font-medium shadow-sm">
                1
              </button>
              <button className="w-9 h-9 flex items-center justify-center rounded-md bg-white border border-outline-variant/10 text-secondary/60 text-xs font-normal hover:bg-surface-container-low transition-all">
                2
              </button>
              <button className="w-9 h-9 flex items-center justify-center rounded-md bg-white border border-outline-variant/10 text-secondary/60 text-xs font-normal hover:bg-surface-container-low transition-all">
                3
      ...
      <div className="fixed top-0 right-0 -z-10 w-full h-full opacity-30 pointer-events-none">
        <div className="absolute top-0 right-0 w-[1000px] h-[1000px] bg-[radial-gradient(circle_at_top_right,_#dae2ff_0%,_transparent_70%)] blur-[120px]"></div>
      </div>
    </>
  );
}
